...
function subprint(i){
    ...
    for(let a of ARR){
        ...
        <td>
            <p id="KQ" style="color:#${KQ==='X'?'f67280':'07689f'};font-weight:bold;">${a.STC!==0?KQ:""}</p>
        </td>
        `
...
function diem(){
    if(localStorage.foo!=null){
        ...
        let e2=document.querySelector('.sign-out');
        if(e1!=null) e1.innerHTML='';
        if(e2!=null) e2.innerHTML='';    
        setTimeout(function(){
        print();
    },50);
    }
